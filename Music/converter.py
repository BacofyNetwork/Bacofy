...
class BacofyApp(ctk.CTk):
    def __init__(self):
        super().__init__()
        self.title("BACOFY RAW (Single List)")
        self.geometry("550x550") # Etwas kleiner, da ein Feld fehlt
        ...
        # Genre-Feld wurde komplett entfernt!
    ...
    def process(self):
        ...
        # Alles kommt jetzt in den "Music" Ordner
        music_dir = "Music" 
